...
//here II got this from the exercise but it is just an efficient search starting from the middle. Had to change it from an array form to vector form though
